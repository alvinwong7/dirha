...
$test='../../../export/corpora5/*'
cat $test/11-13.1/wsj0/doc/indices/train/tr_s_wv1.ndx | \
...
cat $test/13-34.1/wsj1/doc/indices/si_tr_s.ndx \
 $test/11-13.1/wsj0/doc/indices/train/tr_s_wv1.ndx | \
 $local/ndx2flist.pl  $* | sort | \
...
find $test/13-16.1/***1/**_**_20 -print | grep -i ".wv1" | sort > dev_dt_20.flist
find $test/13-16.1/***1/**_**_05 -print | grep -i ".wv1" | sort > dev_dt_05.flist
...
cp $test/13-32.1/wsj1/doc/lng_modl/vocab/wfl_64.lst $lmdir
...
cp $test/13-32.1/wsj1/doc/lng_modl/base_lm/bcb20onp.z $lmdir/lm_bg.arpa.gz || exit 1;
chmod u+w $lmdir/lm_bg.arpa.gz

# trigram would be:
cat $test/13-32.1/wsj1/doc/lng_modl/base_lm/tcb20onp.z | \
...
cp $test/13-32.1/wsj1/doc/lng_modl/base_lm/bcb05onp.z  $lmdir/lm_bg_5k.arpa.gz || exit 1;
chmod u+w $lmdir/lm_bg_5k.arpa.gz

# trigram would be: !only closed vocabulary here!
cp $test/13-32.1/wsj1/doc/lng_modl/base_lm/tcb05cnp.z $lmdir/lm_tg_5k.arpa.gz || exit 1;
...
cat $test/11-13.1/wsj0/doc/spkrinfo.txt \
    $test/13-32.1/wsj1/doc/evl_spok/spkrinfo.txt \
    $test/13-34.1/wsj1/doc/dev_spok/spkrinfo.txt \
    $test/13-34.1/wsj1/doc/train/spkrinfo.txt \
